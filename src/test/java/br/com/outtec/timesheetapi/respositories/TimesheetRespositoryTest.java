...
public class TimesheetRespositoryTest {
	...
	private static final String COLABORADOR = "Juice";
	
	@Before 
	public void setUp() throws Exception{
		Timesheet timesheet = new Timesheet();
		timesheet.setColaborador("Juice");
	...
	public void testFindByColaborador() {
		Timesheet timehseet = this.timehseetRepository.findByColaborador(COLABORADOR);
		
		assertEquals(COLABORADOR, timehseet.getColaborador());
	}
